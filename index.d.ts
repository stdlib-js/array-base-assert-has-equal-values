...
* // returns true
*/
declare function hasEqualValues<T = unknown, U = unknown>( x: Collection<T> | AccessorArrayLike<T>, y: Collection<U> | AccessorArrayLike<U> ): boolean;


// EXPORTS //

export = hasEqualValues;
